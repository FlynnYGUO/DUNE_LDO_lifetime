...
void plot_degradation_LP_stress() {
    ...
    TString FileIn7 = "/Users/flynnguo/Documents/SBU/NN/DUNE/FD_PDS/LDO_Lifetime/Plots/24Sep20/LP27_7.00to10.30_ADM27_7.00to10.30.root";
    ...
    for (int i = 0; i < chain_s->GetEntries(); i++) {
        ...
        if (batchNumber_s==10) {
            ...
            if(n1==2) cout << "batchNumber: " << batchNumber_s << ", LP_ave_s_ini: " << LP_ave_s_ini << endl;
        } else if (batchNumber_s==22 ) {
            gr2->SetPoint(n2++, t_measure_s, D_LP_max);
            if(n2==2) cout << "batchNumber: " << batchNumber_s << ", LP_ave_s_ini: " << LP_ave_s_ini << endl;
        } else if (batchNumber_s==23 ) {
            gr3->SetPoint(n3++, t_measure_s, D_LP_max);
            if(n3==2) cout << "batchNumber: " << batchNumber_s << ", LP_ave_s_ini: " << LP_ave_s_ini << endl;
        } else if (batchNumber_s==25 ) {
            gr4->SetPoint(n4++, t_measure_s, D_LP_max);
            if(n4==2) cout << "batchNumber: " << batchNumber_s << ", LP_ave_s_ini: " << LP_ave_s_ini << endl;
        } else if (batchNumber_s==26 ) {
            gr5->SetPoint(n5++, t_measure_s, D_LP_max);
            if(n5==2) cout << "batchNumber: " << batchNumber_s << ", LP_ave_s_ini: " << LP_ave_s_ini << endl;
        }else if (batchNumber_s==19 ) {
            gr6->SetPoint(n6++, t_measure_s, D_LP_max);
            if(n6==2) cout << "batchNumber: " << batchNumber_s << ", LP_ave_s_ini: " << LP_ave_s_ini << endl;
        }else if (batchNumber_s==27 ) {
            gr7->SetPoint(n7++, t_measure_s, D_LP_max);
            if(n7==2) cout << "batchNumber: " << batchNumber_s << ", LP_ave_s_ini: " << LP_ave_s_ini << endl;
        }
    }
    ...
    mg1->SetTitle("Lifetime study on LP LDO - stress; Time [days]; Vout Difference [%]");
    ...
    mg1->SetMinimum(-1.3); // Set the minimum for the y-axis
    ...
    // legend->AddEntry(gr1, "LP#10: Vnominal=7V, Vstress=8V, Vini=4.92931V", "lp");
    legend->AddEntry(gr6, "LP#19: Vnominal=7V, Vstress=10V, Vini=5.84492V", "lp");
    legend->AddEntry(gr2, "LP#22: Vnominal=7V, Vstress=10.3V, Vini=6.01044V", "lp");
    legend->AddEntry(gr3, "LP#23: Vnominal=7V, Vstress=10.3V, Vini=5.97684V", "lp");
    legend->AddEntry(gr4, "LP#25: Vnominal=7V, Vstress=10.3V, Vini=5.98056V", "lp");
    legend->AddEntry(gr5, "LP#26: Vnominal=7V, Vstress=10.3V, Vini=5.98594V", "lp");
    legend->AddEntry(gr7, "LP#27: Vnominal=7V, Vstress=10.3V, Vini=5.9646V", "lp");
    legend->Draw();

    // If you want to save the canvas as an ima
    canvas->SaveAs("/Users/flynnguo/Documents/SBU/NN/DUNE/FD_PDS/LDO_Lifetime/Plots/24Sep20/LP_stress_voltage_degradation_10222325261927.png");
    canvas->SaveAs("/Users/flynnguo/Documents/SBU/NN/DUNE/FD_PDS/LDO_Lifetime/Plots/24Sep20/LP_stress_voltage_degradation_10222325261927.root");
...
void plot_degradation_ADM_stress() {
    ...
    TString FileIn8 = "/Users/flynnguo/Documents/SBU/NN/DUNE/FD_PDS/LDO_Lifetime/Plots/24Sep20/LP27_7.00to10.30_ADM27_7.00to10.30.root";
    ...
    chain_s->Add(FileIn6.Data()); // Replace with the actual file paths and names
    chain_s->Add(FileIn7.Data()); // Replace with the actual file paths and names
    chain_s->Add(FileIn8.Data()); // Replace with the actual file paths and names
    // Add as many files as you have
    ...
    gr8->SetMarkerColor(kOrange);
    gr8->SetLineColor(kOrange);
    // You might need to create as many TGraphs as your datasets

    int n1 = 0, n2 = 0, n3 = 0, n4=0, n5=0, n6=0,n7=0,n8=0; // Indices for each graph
    ...
    for (int i = 0; i < chain_s->GetEntries(); i++) {
        ...
        }else if ( batchNumber== 27 ) {
            gr8->SetPoint(n8++, t_measure_s, D_ADM_max);
            if(n8==2) cout << "batchNumber: " << batchNumber << ", ADM_ave_s_ini: " << ADM_ave_s_ini << endl;
        }
    }
    ...
    gPad->Update();
    auto mg1 = new TMultiGraph();
    mg1->SetTitle("Lifetime study on ADM LDO - stress; Time [days]; Vout Difference [%]");
    mg1->Add(gr1);
    mg1->Add(gr2);
    mg1->Add(gr3);
    mg1->Add(gr4);
    ...
    legend->AddEntry(gr8, "ADM#27: Vnominal=7V, Vstress=10.3V, Vini=4.98973V", "lp");
    legend->Draw();

    // If you want to save the canvas as an image
    canvas->SaveAs("/Users/flynnguo/Documents/SBU/NN/DUNE/FD_PDS/LDO_Lifetime/Plots/24Sep20/ADM_stress_voltage_degradation1922121023252627.png");
    canvas->SaveAs("/Users/flynnguo/Documents/SBU/NN/DUNE/FD_PDS/LDO_Lifetime/Plots/24Sep20/ADM_stress_voltage_degradation1922121023252627.root");

}// end plot_degradation_ADM_stress

void plot_degradation_LP_nominal() {
    ...
    chain_n->Add(FileIn3.Data()); // Replace with the actual file paths and names
    chain_n->Add(FileIn4.Data()); // Replace with the actual file paths and names
    chain_n->Add(FileIn5.Data()); // Replace with the actual file paths and names
    chain_n->Add(FileIn6.Data()); // Replace with the actual file paths and names
    chain_n->Add(FileIn7.Data()); // Replace with the actual file paths and names
    ...
    // Loop over the chain and fill the graphs
    for (int i = 0; i < chain_n->GetEntries(); i++) {
        chain_n->GetEntry(i);
        // D_LP_max = (LP_ave_s_max - LP_ave_s)*100/LP_ave_s_max;
        D_LP_max = (LP_ave_n - LP_ave_n_ini)*100/LP_ave_n_ini;
        ...
        if (batchNumber_n==10) {
            ...
            if(n1==2) cout << "batchNumber: " << batchNumber_n << ", LP_ave_n_ini: " << LP_ave_n_ini << endl;
        } else if (batchNumber_n==22 ) {
            gr2->SetPoint(n2++, t_measure_n, D_LP_max);
            if(n2==2) cout << "batchNumber: " << batchNumber_n << ", LP_ave_n_ini: " << LP_ave_n_ini << endl;
        } else if (batchNumber_n==23 ) {
            gr3->SetPoint(n3++, t_measure_n, D_LP_max);
            if(n3==2) cout << "batchNumber: " << batchNumber_n << ", LP_ave_n_ini: " << LP_ave_n_ini << endl;
        } else if (batchNumber_n==25 ) {
            gr4->SetPoint(n4++, t_measure_n, D_LP_max);
            if(n4==2) cout << "batchNumber: " << batchNumber_n << ", LP_ave_n_ini: " << LP_ave_n_ini << endl;
        } else if (batchNumber_n==26 ) {
            gr5->SetPoint(n5++, t_measure_n, D_LP_max);
            if(n5==2) cout << "batchNumber: " << batchNumber_n << ", LP_ave_n_ini: " << LP_ave_n_ini << endl;
        }else if (batchNumber_n==19 ) {
            gr6->SetPoint(n6++, t_measure_n, D_LP_max);
            if(n6==2) cout << "batchNumber: " << batchNumber_n << ", LP_ave_n_ini: " << LP_ave_n_ini << endl;
        }else if (batchNumber_n==27 ) {
            gr7->SetPoint(n7++, t_measure_n, D_LP_max);
            if(n7==2) cout << "batchNumber: " << batchNumber_n << ", LP_ave_n_ini: " << LP_ave_n_ini << endl;
        }
    }
    ...
    // gr4->Fit(fitFunc4, "LR+");
    // Create a canvas to draw the plots
    TCanvas *canvas = new TCanvas("canvas", "Voltage Difference", 2400, 1600);
    // canvas->SetLeftMargin(0.1);
    // canvas->SetRightMargin(0.05);
    ...
    gPad->Update();
    auto mg1 = new TMultiGraph();
    mg1->SetTitle("Lifetime study on LP LDO - nominal; Time [days]; Vout Difference [%]");
    // mg1->SetTitle("Lifetime study on LP LDO - nominal; Time [days]; Vout Degradation [%]");
    mg1->Add(gr1);
    mg1->Add(gr2);
    mg1->Add(gr3);
    ...
    // Add a legend
    TLegend *legend = new TLegend(0.1, 0.7, 0.4, 0.9);
    legend->AddEntry(gr1, "LP#10: Vnominal=7V, Vstress=8V, Vini=4.92682V", "lp");
    legend->AddEntry(gr2, "LP#22: Vnominal=7V, Vstress=10.3V, Vini=4.90076V", "lp");
    legend->AddEntry(gr3, "LP#23: Vnominal=7V, Vstress=10.3V, Vini=4.87418V", "lp");
    legend->AddEntry(gr4, "LP#25: Vnominal=7V, Vstress=10.3V, Vini=4.85424V", "lp");
    legend->AddEntry(gr5, "LP#26: Vnominal=7V, Vstress=10.3V, Vini=4.90433V", "lp");
    legend->AddEntry(gr6, "LP#19: Vnominal=7V, Vstress=10V, Vini=4.91462V", "lp");
    legend->AddEntry(gr7, "LP#27: Vnominal=7V, Vstress=10.3V, Vini=4.84271V", "lp");
    legend->Draw();

    // If you want to save the canvas as an ima
    canvas->SaveAs("/Users/flynnguo/Documents/SBU/NN/DUNE/FD_PDS/LDO_Lifetime/Plots/24Sep20/LP_nominal_voltage_degradation_10222325261927.png");
    canvas->SaveAs("/Users/flynnguo/Documents/SBU/NN/DUNE/FD_PDS/LDO_Lifetime/Plots/24Sep20/LP_nominal_voltage_degradation_10222325261927.root");
    // canvas->SaveAs("/Users/flynnguo/Documents/SBU/NN/DUNE/FD_PDS/LDO_Lifetime/Plots/24May9/LP_nominal_voltage_degradation.pdf");

}// end plot_degradation_LP_nominal

void plot_degradation_ADM_nominal() {
    ...
    chain_n->Add(FileIn6.Data()); // Replace with the actual file paths and names
    chain_n->Add(FileIn7.Data()); // Replace with the actual file paths and names
    chain_n->Add(FileIn8.Data()); // Replace with the actual file paths and names
    // Add as many files as you have
    ...
    for (int i = 0; i < chain_n->GetEntries(); i++) {
        ...
        // D_ADM_max = (ADM_ave_s_max - ADM_ave_s)*100/ADM_ave_s_max;
        // Compared to the initial value
        D_ADM_max = (ADM_ave_n - ADM_ave_n_ini)*100/ADM_ave_n_ini;
        // cout << "D_ADM_max: " << D_ADM_max << endl;
        t_measure_n = t_measure_n/(60*24); // change units to day
        if( D_ADM_max == 0) cout<< i << ", max time: "<< t_measure_n << endl;
        // gr1->SetPoint(n1++, t_measure_n, D_LP_max);
        // // Depending on your condition, assign points to different graphs
        // // This is a placeholder; you'll need to replace it with your actual logic
        if ( batchNumber_n==19 ) {
            gr1->SetPoint(n1++, t_measure_n, D_ADM_max);
            if(n1==2) cout << "batchNumber_n: " << batchNumber_n << ", ADM_ave_n_ini: " << ADM_ave_n_ini << endl;
        } else if ( batchNumber_n==22 ) {
            gr2->SetPoint(n2++, t_measure_n, D_ADM_max);
            if(n2==2) cout << "batchNumber_n: " << batchNumber_n << ", ADM_ave_n_ini: " << ADM_ave_n_ini << endl;
        } else if ( batchNumber_n== 12 ) {
            gr3->SetPoint(n3++, t_measure_n, D_ADM_max);
            if(n3==2) cout << "batchNumber_n: " << batchNumber_n << ", ADM_ave_n_ini: " << ADM_ave_n_ini << endl;
        } else if ( batchNumber_n== 10 ) {
            gr4->SetPoint(n4++, t_measure_n, D_ADM_max);
            if(n4==2) cout << "batchNumber_n: " << batchNumber_n << ", ADM_ave_n_ini: " << ADM_ave_n_ini << endl;
        } else if ( batchNumber_n== 23 ) {
            gr5->SetPoint(n5++, t_measure_n, D_ADM_max);
            if(n5==2) cout << "batchNumber_n: " << batchNumber_n << ", ADM_ave_n_ini: " << ADM_ave_n_ini << endl;
        } else if ( batchNumber_n== 25 ) {
            gr6->SetPoint(n6++, t_measure_n, D_ADM_max);
            if(n6==2) cout << "batchNumber_n: " << batchNumber_n << ", ADM_ave_n_ini: " << ADM_ave_n_ini << endl;
        } else if ( batchNumber_n== 26 ) {
            gr7->SetPoint(n7++, t_measure_n, D_ADM_max);
            if(n7==2) cout << "batchNumber_n: " << batchNumber_n << ", ADM_ave_n_ini: " << ADM_ave_n_ini << endl;
        }else if ( batchNumber_n== 27 ) {
            gr8->SetPoint(n8++, t_measure_n, D_ADM_max);
            if(n8==2) cout << "batchNumber_n: " << batchNumber_n << ", ADM_ave_n_ini: " << ADM_ave_n_ini << endl;
        }
    }
    ...
    gPad->Update();
    auto mg1 = new TMultiGraph();
    mg1->SetTitle("Lifetime study on ADM LDO - nominal; Time [days]; Vout Difference [%]");
    mg1->Add(gr1);
    mg1->Add(gr2);
    mg1->Add(gr3);
    mg1->Add(gr4);
    ...
    // // Add a legend
    TLegend *legend = new TLegend(0.1, 0.7, 0.4, 0.9);
    legend->AddEntry(gr1, "ADM#19: Vnominal=7V, Vstress=21V, Vini=4.98614V", "lp");
    legend->AddEntry(gr2, "ADM#22: Vnominal=7V, Vstress=10.3V, Vini=5.12255V", "lp");
    legend->AddEntry(gr3, "ADM#12: Vnominal=7V, Vstress=19.5V, Vini=4.97208V", "lp");
    legend->AddEntry(gr4, "ADM#10: Vnominal=7V, Vstress=16V, Vini=4.96624V", "lp");
    legend->AddEntry(gr5, "ADM#23: Vnominal=7V, Vstress=10.3V, Vini=5.05819V", "lp");
    legend->AddEntry(gr6, "ADM#25: Vnominal=7V, Vstress=10.3V, Vini=5.00173V", "lp");
    legend->AddEntry(gr7, "ADM#26: Vnominal=7V, Vstress=10.3V, Vini=5.04971V", "lp");
    legend->AddEntry(gr8, "ADM#27: Vnominal=7V, Vstress=10.3V, Vini=4.98222V", "lp");
    legend->Draw();

    // If you want to save the canvas as an image
    canvas->SaveAs("/Users/flynnguo/Documents/SBU/NN/DUNE/FD_PDS/LDO_Lifetime/Plots/24Sep20/ADM_nominal_voltage_degradation1922121023252627.png");
    canvas->SaveAs("/Users/flynnguo/Documents/SBU/NN/DUNE/FD_PDS/LDO_Lifetime/Plots/24Sep20/ADM_nominal_voltage_degradation1922121023252627.root");

}// end plot_degradation_ADM_nominal
